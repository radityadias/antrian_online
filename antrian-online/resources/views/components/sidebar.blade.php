<header>
    <nav class="w-full sticky bg-primary-accent border-b border-secondary-white px-10 py-3">
...
<aside id="sidebar" class="fixed left-0 z-20 w-64 h-full">
    <di class="w-full h-full px-3 py-4 space-y-5 bg-primary-accent text-white flex flex-col">
        ...
        <ul
            class="p-2 font-medium space-x-2 rounded-md transition-all duration-200 hover:scale-105 hover:bg-secondary-blue active:scale-95">
            <li>
                <a href="/dashboard/antrian" class="flex items-center gap-5">
                    <svg fill="#ffffff" width="18px" height="18px" viewBox="0 0 256 256" id="Flat"
                        xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                    ...
                    <svg width="18px" height="18px" viewBox="0 0 512 512" version="1.1"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="log-white" fill="#ffffff" transform="translate(85.572501, 42.666667)">
                                    <path
        ...
        <ul
            class="p-2 mt-5 font-medium space-x-2 rounded-md transition-all duration-200 hover:scale-105 hover:bg-secondary-blue active:scale-95">
            <li>
                    ...
                    <svg width="18px" height="18px" viewBox="0 0 24 24" fill="none"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path>
                            <path d="M12 11V13" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path>
                        </g>
                    </svg>
                    Keluar
                </a>
